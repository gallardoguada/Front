...
.bg-inf-darkgray {
  background-color: #9292A0 !important;
}
...
.nav-tabs .nav-link.active-inf,
.nav-tabs .nav-item.show .nav-link {
  color: #495057;
  background-color: #EAEAEA;
}

.nav-tabs .nav-link.inactive-inf,
.nav-tabs .nav-item.show .nav-link {
  color: #495057;
...
.shad-inf {
  box-shadow: 10px 0 20px rgba(47, 49, 52, 0.1);
  z-index: 2;
